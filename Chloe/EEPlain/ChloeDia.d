...
IF ~~ THEN BEGIN MyPrice1 // charisma checks galore
   SAY @211
   IF ~PartyGoldGT(999)~ THEN REPLY @206 DO ~ActionOverride(Player1,DestroyGold(1000))~ GOTO NiceBusiness
   IF ~CheckStatGT(Player1,13,CHR) !PartyGoldGT(999) PartyGoldGT(499) GGT("Chapter",3)~ THEN REPLY @212 GOTO MyPrice500Okay
   IF ~!CheckStatGT(Player1,13,CHR) !PartyGoldGT(999) PartyGoldGT(499) GGT("Chapter",3)~ THEN REPLY @212 GOTO NotNegotiable
   IF ~CheckStatGT(Player1,13,CHR) !PartyGoldGT(999) PartyGoldGT(499) !GGT("Chapter",3)~ THEN REPLY @213 GOTO MyPrice500Okay
   IF ~!CheckStatGT(Player1,13,CHR) !PartyGoldGT(999) PartyGoldGT(499) !GGT("Chapter",3)~ THEN REPLY @213 GOTO NotNegotiable
...
IF ~~ THEN BEGIN RejoinPayMe2
 SAY @1303
  ...
  IF ~CheckStatGT(Player1,14,CHR) GLT("Chapter",4)~ THEN REPLY @1306 GOTO WhoaYup
  IF ~OR(2) !CheckStatGT(Player1,14,CHR) !GLT("Chapter",4)~ THEN REPLY @1306 GOTO WhoaNope
END
